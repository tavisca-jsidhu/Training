<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.ascx.cs" Inherits="EMSWidgets.ChangePassword" %>
...
<table class="auto-style1">
    ...
    <tr>
        <td class="auto-style5">&nbsp;</td>
        <td class="auto-style3">
            <asp:Button ID="ButtonChangePass" runat="server" Text="Button" Width="85px" ValidationGroup="ModifyPassword" OnClick="ButtonChangePass_Click" />
