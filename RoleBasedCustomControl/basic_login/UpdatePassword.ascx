...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td class="auto-style3">
            <asp:TextBox ID="TextBoxChangeEmail" runat="server" Width="180px" ValidationGroup="UpdatePassword"></asp:TextBox>
        </td>
        <td class="auto-style7">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxChangeEmail" ErrorMessage="Email is Required." ForeColor="Red"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        <td class="auto-style6">Current Password :</td>
        <td class="auto-style4">
            <asp:TextBox ID="TextBoxChangeOld" runat="server" TextMode="Password" Width="180px" ValidationGroup="UpdatePassword"></asp:TextBox>
        </td>
    ...
    <tr>
        ...
        <td class="auto-style3">
            <asp:TextBox ID="TextBoxChangeNew" runat="server" TextMode="Password" Width="180px" ValidationGroup="UpdatePassword"></asp:TextBox>
        </td>
        <td class="auto-style7">
    ...
    <tr>
        ...
        <td class="auto-style3">
            <asp:TextBox ID="TextBoxChangeConfirm" runat="server" TextMode="Password" Width="180px" ValidationGroup="UpdatePassword"></asp:TextBox>
        </td>
        <td class="auto-style7">
    ...
    <tr>
        <td class="auto-style5">&nbsp;</td>
        <td class="auto-style3">
            <asp:Button ID="ButtonChangePass" runat="server" Text="Button" Width="85px" OnClick="ButtonChangePass_Click" ValidationGroup="UpdatePassword" />
