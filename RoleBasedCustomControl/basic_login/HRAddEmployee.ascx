<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HRAddEmployee.ascx.cs" Inherits="basic_login.HRAddEmployee" %>
<style type="text/css">
    .auto-style1 {
        width: 100%;
    }
...
<table class="auto-style1">
    ...
    <tr>
        ...
        <td class="auto-style7">
            <asp:TextBox ID="TextBoxAddPhone" runat="server" Width="180px" TextMode="Number" ValidationGroup="AddEmployee"></asp:TextBox>
        </td>
        <td class="auto-style5">
    ...
    <tr>
        <td class="auto-style6">&nbsp;</td>
        <td class="auto-style7">
            <asp:Button ID="ButtonNewEmp" runat="server" Text="Submit" Height="25px" Width="80px" OnClick="ButtonNewEmp_Click" ValidationGroup="AddEmployee" />
