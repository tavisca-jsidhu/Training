<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginUser.ascx.cs" Inherits="basic_login.basic.Login" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">
                    &nbsp;</td>
                <td class="auto-style3">
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" Width="80px" ValidationGroup="UserLogin" style="height: 26px" />
